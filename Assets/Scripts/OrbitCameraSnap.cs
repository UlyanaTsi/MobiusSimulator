...
public class OrbitCameraSnap : MonoBehaviour {
    [SerializeField] Transform focus = default;
    [SerializeField, Range(1f, 40f)] float distance = 40f;
	[SerializeField, Min(0f)] float focusRadius = 1f;
	[SerializeField, Range(0f, 1f)] float focusCentering = 0.5f;
	[SerializeField, Range(1f, 360f)] float rotationSpeed = 100f;
	[SerializeField, Range(-351f, 351f)] 	float minVerticalAngle = -350f, maxVerticalAngle = 350f;
	...
	void UpdateGravityAlignment()
	{
		...
		Vector3 toUp = MovingSphereSnap.upAxis;
